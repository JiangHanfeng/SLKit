//
//  SLAdjustingSensitivityBigHintViewController.swift
//  OMNIEnjoy
//
//  Created by shenjianfei on 2023/11/24.
//

import UIKit

class SLAdjustingSensitivityBigHintViewController: UIViewController {
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = NSLocalizedString("SLAdjustingSensitivityBigHintString", comment: "")
        return label
    }()
    ...
    private lazy var contentLabel: UILabel = {
        ...
        let str1 = NSLocalizedString("SLAdjustingSensitivityBigHintContentString1", comment: "")
        let str2 = NSLocalizedString("SLAdjustingSensitivityBigHintContentString2", comment: "")
        let str3 = NSLocalizedString("SLAdjustingSensitivityBigHintContentString3", comment: "")
        
        let style = NSMutableParagraphStyle()
        style.lineSpacing = 5
        style.alignment = .center
        let attr = NSMutableAttributedString(string: "\(str1)\(str2)\(str3)", attributes: [NSAttributedString.Key.paragraphStyle: style])
    ...
    private lazy var imageView: UIImageView = {
        ...
        imageView.image = UIImage.init(named: "adjusting_sensitivity_big_hint_img")
        return imageView
    }()
    ...
    private lazy var settingBtn: UIButton = {
        let btn = UIButton()
        btn.setTitle(NSLocalizedString("SLAdjustingSensitivityBigHintSettingTitle", comment: ""), for: .normal)
        btn.setTitleColor(UIColor.colorWithHex(hexStr: "#335EFF"), for: .normal)
        btn.titleLabel?.font = UIFont.font(15,.regular)
