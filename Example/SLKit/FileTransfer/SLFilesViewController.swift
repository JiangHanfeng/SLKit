...
//
//
//class SLFilesViewController: SCLBaseViewController {
//    
//    private lazy var isEdit = false
//    private var device: SLDevice?
//    private let fileManager = SLFileManager()
//    
...
//            }
//            for file in files {
//                fileManager.deleteFile(withPath: "\(filesPath)\(file.fullPath)")
//            }
//            let appDeleget = UIApplication.shared.delegate as? AppDelegate
//            self?.toast(NSLocalizedString("SLFileRemoveSuccessString", comment: ""))
//            return true
//        }
//        
...
//    }
//    
//    func updateRreceiveFileTransferProgress(_ device: SLDevice,_ taskId: String,_ progress: Float){
