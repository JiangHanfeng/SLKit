...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LLNetworkAccessibility-Swift/LLNetworkAccessibility_Swift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SLKit/SLKit.framework"
