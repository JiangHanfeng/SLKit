//
//  SLlocalNetworkAuthorization.swift
//  SLKit
//
...
public class SLLocalNetworkAuthorization: NSObject {
    ...
    public func requestAuthorization(completion: @escaping (Bool) -> Void) {
        ...
        browser.stateUpdateHandler = { newState in
            ...
            case .cancelled:
//                print("Local network permission has been cancelled")
//                self.reset()
...
extension SLLocalNetworkAuthorization : NetServiceDelegate {
